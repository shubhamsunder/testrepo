...
default['ant']['url']            = "http://10.114.10.200:8081/nexus/content/repositories/chef_test/ant/apache-ant/1.8.2/apache-ant-1.8.2-bin.tar.gz"
...
default['ant']['libraries']      = {"ant-contrib" => "http://10.114.10.200:8081/nexus/content/repositories/chef_test/ant/ant-contrib/1.0b3/ant-contrib-1.0b3.jar"}
